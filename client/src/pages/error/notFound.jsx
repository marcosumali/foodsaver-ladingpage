  ...
  render() {
    return (
      <div id="message">
        ...
        <p style={{ textAlign: 'justify' }} >Untuk setiap pertanyaan, silakan hubungi <a style={{ color: '#F45087', textDecoration: 'underline' }} href="mailto:support@dishkon.co">tim support</a> kami atau silahkan kembali <Link style={{ color: '#F45087', textDecoration: 'underline' }} to="/">beranda</Link>.</p>
      </div>
    )
  }
}
