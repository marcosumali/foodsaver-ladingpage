...
class registerAvenger extends Component {
  ...
  componentDidMount() {
    ReactGA.pageview('/rangers-assemble');
  }
  ...
  render() {
    ...
    // console.log('registerRanger', this.props)
    ...
    return (
      <div className="Register-page">
        <Helmet
          title="Food Rangers Assemble | Dishkon"
        />
          ...
          <Row className="Container-nowrap-center">
            <Col md={12} className="Registration-box">
              <Row className="Registration-inner-box">
                <Col md={12}>
                  <div className="Registration-header">Food Rangers Initiative - RSVP</div>
                </Col>
                <Col md={12}>
                  <Form>
                    <Form.Group>
                    ...
                    <Form.Group>
                      <Form.Label style={{ marginTop: '1rem' }}>Kota Tempat Tinggal</Form.Label>
                      <Form.Control 
                        id="city"
                        as="select" 
                        onChange={ (e) => handleUserInputChanges(e) }
